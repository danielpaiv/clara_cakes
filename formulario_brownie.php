...
if(isset($_POST['submit']))
{
    ...
    print_r('pagamentto:' . $_POST['pagamento']);
    print_r('<br>');
     ...
     $result = mysqli_query($conexao, "INSERT INTO  clara(nome,telefone,endereco,numero,data_ped,iten,qtde,valor,sabor,pagamento)
     VALUES ('$nome','$telefone','$endereco','$numero','$data_ped','$iten','$qtde','$valor','$sabor','$pagamento')");
}
?>
...
<head>
    ...
    <title>formulario | brownie</title>
    <style>
        body{
...
<body> 
    <div class="box">
        <form action="formulario_brownie.php" method="POST">
            <fieldset>
                ...
                <input type="radio" id="iten" name="iten" value="Brownie na marmita" required>
                <label for="iten">Brownie na marmita</label>
                               
                <p>Escolha o sabor</p>
                <input type="radio" id="sabor" name="sabor" value="Ninho" required>
                <label for="sabor">Ninho</label>
                
                <input type="radio" id="sabor" name="sabor" value="Choconinho" required>
                <label for="sabor">Choconinho</label>
                
                <input type="radio" id="sabor" name="sabor" value="Dois amores" required>
                <label for="sabor">Dois amores</label>

                <p></p>
                <label for="qtde">Quantidade</label>
                <input type="Number" id="brownie" name="qtde" value="qtde" required>                
                <br>
                <p></p>
                <label for="valor">Valor</label>
                <input type="Number" id="brownie" name="valor" value="valor" required>
                <br>
                <p>Forma de pagamento</p>
                <input type="radio" id="pagamento" name="pagamento" value="pix" required>
                <label for="pagamentto">Pix</label>

                <input type="radio" id="pagamento" name="pagamento" value="dinheiro" required>
                <label for="pagamentto">Dinheiro</label>
